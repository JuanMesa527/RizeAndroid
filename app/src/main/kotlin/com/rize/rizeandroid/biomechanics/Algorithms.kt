...
/**}
 * Clase central para la gestión de algoritmos biomecánicos. Contiene instancias de algoritmos específicos para diferentes ejercicios (curl, sentadilla, press de banca) 
 * y permite cambiar entre ellos en función del tipo o el nombre del ejercicio. También gestiona el suavizado de los datos de puntos de referencia antes de procesarlos 
 * mediante el algoritmo activo. Los resultados del algoritmo se almacenan y se puede acceder a ellos a través de una llamada de retorno.
 */
class Algorithms {
    ...
    /**
     * Selecciona el algoritmo activo en función del tipo de ejercicio. Al cambiar de algoritmo, se restablecen tanto el algoritmo 
     * como los suavizadores de puntos de referencia para garantizar que no haya contaminación de datos entre ejercicios. 
     */
    ...
    /**
     * Selecciona el algoritmo activo en función del nombre del ejercicio. Utiliza coincidencias de texto para determinar el tipo de ejercicio, 
     * lo que permite cierta flexibilidad en los nombres (por ejemplo, "curl con mancuerna" o "sentadilla profunda"). Al igual que con la selección por tipo, 
     * se restablecen el algoritmo y los suavizadores al cambiar para evitar contaminación de datos.
     */
    ...
    /**
     * Devuelve el suavizador de puntos de referencia correspondiente al algoritmo activo. Esto permite que cada algoritmo tenga parámetros de suavizado optimizados 
     * para su tipo de movimiento,
     */
    ...
    /**
     * Procesa los datos de puntos de referencia recibidos. Primero, se suavizan los datos utilizando el suavizador correspondiente al algoritmo activo. 
     * Luego, se pasan los datos suavizados al algoritmo para su procesamiento. El resultado del algoritmo se almacena y se invoca la llamada de retorno con el nuevo resultado.
     */
    ...
    /**
     * Versión de onPoseData que acepta un timestamp específico. Esto es útil si los datos de puntos de referencia no se reciben en tiempo real o si se desea 
     * una mayor precisión en el cálculo de la velocidad angular y la aceleración angular,
     */
    ...
    /**
     * Restablece el estado del algoritmo activo y los suavizadores de puntos de referencia. Esto es útil cuando se cambia de ejercicio o se desea reiniciar 
     * el seguimiento sin cambiar de algoritmo.
     */
    fun reset() {
        activeAlgorithm.reset()
        landmarkSmoother.reset()
