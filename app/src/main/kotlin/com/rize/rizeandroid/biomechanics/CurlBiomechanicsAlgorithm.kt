...
/** 
 * Algoritmo de biomecánica para curl de bíceps, basado en el análisis de ángulo de codo y compensaciones.
 */
...
/**
 * Procesa una nueva lista plana de landmarks (132 valores: x,y,z,visibilidad para 33 puntos) y devuelve un resultado con métricas de biomecánica, 
 * detección de fatiga y errores técnicos.
 */
...
/**
 * Calcula el ángulo de flexión del codo a partir de las posiciones 3D del hombro, codo y muñeca usando el producto punto.
 */
...
/**
 * Calcula el ángulo vertical del brazo superior (hombro a codo) respecto a la horizontal, para detectar compensación de hombro.
 */
    ...
    /**
     * Detecta el conteo de repeticiones basado en umbrales de ángulo para flexión y extensión, con lógica de intento para evitar conteos erróneos por oscilaciones.
     */
    ...
    /**
     * Calcula la desviación estándar de una lista de valores, usando la fórmula de la muestra (dividiendo por n-1).
     */
...
/**
 * Detecta fatiga basándose en la pérdida de velocidad máxima de flexión (VL) comparada con el pico de referencia, y en el aumento de la variabilidad del ángulo de codo.
 */
    ...
    /**
     * Calcula la varianza de una colección de valores.
     */
    ...
    /**
     * Clasifica el error técnico de la repetición actual basándose en la desviación del pico de flexión respecto al pico de referencia, el rango 
     * de movimiento alcanzado y la compensación del hombro.
     */
    ...
    /**
     * Selecciona el brazo a analizar (derecho o izquierdo) basado en la visibilidad de los landmarks, y bloquea la selección una vez que se ha decidido 
     * para evitar cambios erráticos durante la serie.
     */
    ...
    /**
     * Clase auxiliar para representar las posiciones 3D de hombro, codo y muñeca de un brazo seleccionado, extraídas de la lista plana de landmarks.
     */
