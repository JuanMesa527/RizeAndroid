...
/**
 * CameraView esta personalizado para mostrar la vista previa de la cámara y superponer los resultados del pose estimation utilizando MediaPipe.
 * Se encarga de configurar la cámara, procesar los frames en tiempo real y actualizar la superposición con los landmarks detectados. Además, permite cambiar entre
 * la cámara frontal y trasera, y maneja la liberación de recursos cuando ya no se necesita la cámara.
 */
class CameraView(
    ...
    /**
     * Configura MediaPipe para el análisis de pose.
     */
    ...
    /**
     * Maneja los errores de MediaPipe.
     */
    ...
    /**
     * Maneja los resultados del análisis de pose.
     */
