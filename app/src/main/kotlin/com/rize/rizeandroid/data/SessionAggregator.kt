...
object PendingSessionBuilder {
    ...
    /**
     * Construye un PendingSessionData a partir de los datos de sesión y reps.
     */
    @JvmStatic
    fun build(
        exerciseType: String,
    ...
    /**
     * Crea un PendingRep para Squat a partir del AlgorithmResult emitido tras cerrar la rep. session_id y rep_id se cablean en el repository.
     */
    @JvmStatic
    fun buildSquatRep(
        repNumber: Int,
    ...
    /**
     * Crea un PendingRep para Curl a partir del AlgorithmResult emitido tras cerrar la rep. session_id y rep_id se cablean en el repository.
     */
    @JvmStatic
    fun buildCurlRep(
        repNumber: Int,
        ...
        val romOk      = rom == null || rom >= 85.0
        val romPartial = rom == null || rom >= 65.0
        val shoulderOk   = shoulderComp == null || shoulderComp < 12.0
        val shoulderWarn = shoulderComp != null && shoulderComp < 17.0
    ...
    /**
     * Crea un PendingRep para Bench a partir del AlgorithmResult emitido tras cerrar la rep. session_id y rep_id se cablean en el repository.
     */
    @JvmStatic
    fun buildBenchRep(
        repNumber: Int,
    ...
    /**
     * Construye un SquatSessionDetails a partir de la lista de reps acumulada durante la sesión y el resultado final del algoritmo. session_id se cablea en el repository.
     */
    ...
    /**
     * Construye un CurlSessionDetails a partir de la lista de reps acumulada durante la sesión y el resultado final del algoritmo. session_id se cablea en el repository.
     */
    ...
    /**
     * Construye un BenchSessionDetails a partir de la lista de reps acumulada durante la sesión y el resultado final del algoritmo. session_id se cablea en el repository.
     */
    ...
    /**
     * Calcula el promedio de una lista de valores, excluyendo los nulos.
     */
