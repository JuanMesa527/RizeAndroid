...
/**
 * Data accesor object (DAO) para manejar las operaciones de base de datos relacionadas con las repeticiones (reps) de una sesión de entrenamiento.
 * Proporciona métodos para insertar nuevas repeticiones y detalles específicos de cada tipo de ejercicio, así como para recuperar las repeticiones y sus 
 * detalles asociados a una sesión dada.
 */
@Dao
interface RepDao {
