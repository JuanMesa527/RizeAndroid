...
/**
 * Data accesor object (DAO) para manejar las operaciones de base de datos relacionadas con las sesiones de entrenamiento.
 * Proporciona métodos para insertar nuevas sesiones y detalles específicos de cada tipo de ejercicio, así como para recuperar las sesiones y sus 
 * detalles asociados.
 */
@Dao
