...
public class SessionHistoryDetailActivity extends AppCompatActivity {
    ...
    /**
     * Carga los datos de la sesión desde la base de datos usando el sessionId pasado en el intent,
     * y muestra el resumen de la sesión usando SummaryUiBinder.
    ...
    /**
     * Configura los botones de acción para una sesión guardada.
     */
