...
public class SummaryActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        super.onDestroy();
        // Si la activity se destruye con datos pendientes (proceso muerto en
        // background, etc.), limpiamos para no leak entre sesiones futuras.
        if (!alreadySaved && isFinishing()) {
            PendingSessionHolder.INSTANCE.clear();
        }
    }
}
